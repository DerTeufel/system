...
typedef enum {
    ...
    AUDIO_STREAM_TTS              = 9,  /* Transmitted Through Speaker.
                                         ...
                                         */
    AUDIO_STREAM_BOOT              = 10, /*For MTK boot animation*/
    AUDIO_STREAM_VIBSPK            = 11, /*For MTK vibration speaker*/
...
typedef enum {
    ...
    AUDIO_CONTENT_TYPE_BOOT         = 5,
    AUDIO_CONTENT_TYPE_VIBSPK       = 6,
 ...
 * Sink and sources are grouped in a concept of ?œaudio port??representing an
