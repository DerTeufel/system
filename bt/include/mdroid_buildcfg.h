...
/* Enable/Disable SSP debug mode from stack config file*/
#ifndef MTK_SSP_DEBUG_MODE_STACK_CONFIG
#define MTK_SSP_DEBUG_MODE_STACK_CONFIG TRUE
...
/* refind BT Snoop log naming */
#ifndef MTK_BTSNOOPLOG_NAME_READABLE
#define MTK_BTSNOOPLOG_NAME_READABLE TRUE
#endif//MTK_BTSNOOPLOG_NAME_READABLE
...
/******************************************************************************
 * **
 * ** Optional HCI Command Settings
 * **
 * ******************************************************************************/

#ifndef MTK_SSP_DEBUG_MODE_HAL_CONFIG
#define MTK_SSP_DEBUG_MODE_HAL_CONFIG TRUE
 ...
 * **
 * ******************************************************************************/
#ifdef MTK_BT_NET_DEBUG
#define BT_NET_DEBUG    TRUE
#endif//MTK_BT_NET_DEBUG
