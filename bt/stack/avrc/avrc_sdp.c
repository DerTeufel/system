...
const tSDP_PROTO_LIST_ELEM  avrc_add_proto_list [] =
{
    ...
    {AVRC_NUM_PROTO_ELEMS,
    {
    {UUID_PROTOCOL_L2CAP, 1, {MTK_BT_PSM_COVER_ART, 0} },
    {UUID_PROTOCOL_OBEX, 0, {0, 0}  }}}
};
#elif MTK_AVRCP_TG_15 == TRUE
const tSDP_PROTO_LIST_ELEM  avrc_add_proto_list [] =
{
    {AVRC_NUM_PROTO_ELEMS,
    {
...
#if (MTK_AVRCP_TG_16 == TRUE)
    /* additional protocol list to include browsing channel and obex channel */
    result &= SDP_AddAdditionProtoLists( sdp_handle, 2, (tSDP_PROTO_LIST_ELEM *)avrc_add_proto_list);
