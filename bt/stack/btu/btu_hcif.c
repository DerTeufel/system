...
static void btu_hcif_3d_ref_proto_assoc_notify_evt(void);
# endif
#endif
...
# if defined(MTK_LEGACY_B3DS_INCLUDED) && (MTK_LEGACY_B3DS_INCLUDED == TRUE)
        case HCI_3D_REF_PROTO_ASSOC_NOTIFY:
            btu_hcif_3d_ref_proto_assoc_notify_evt();
            break;
# endif
#endif
...
static void btu_hcif_3d_ref_proto_assoc_notify_evt(void)
{
    HCI_TRACE_DEBUG("btu_hcif_legacy_assoc_notify_evt");
    B3DS_ProcRefProtoAssocNotifyEvt();
}
#endif
