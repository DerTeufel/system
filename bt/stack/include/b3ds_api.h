...
#define B3DS_PROFILE_VERSION    0x0101   /* Version 1.01 */
...
#define B3DS_EIR_MAX_PATH_LOSS_THRESHOLD    0x5a
...
typedef void (tB3DS_REF_PROTO_ASSOC_NOTIFY_EVT_CB) (void);
#endif
...
extern void B3DS_ProcRefProtoAssocNotifyEvt(void);
