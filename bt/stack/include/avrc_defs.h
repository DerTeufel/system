...
#define AVRC_IS_VALID_SCOPE(a)    ((a <= AVRC_SCOPE_NOW_PLAYING) ? TRUE: FALSE)
...
typedef union
{
    ...
    tAVRC_GET_TOTAL_NUM_CMD     get_total_num;          /* GetTotalNumberofItems */
} tAVRC_COMMAND;
...
typedef union
{
    ...
    tAVRC_SEARCH_RSP                total_num;              /* GetTotalNumberofItems */
} tAVRC_RESPONSE;
