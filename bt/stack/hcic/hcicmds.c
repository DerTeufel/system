                                           ...
                                           UINT16 packet_types, UINT8 retrans_effort)
{
    ...
    if ((p = HCI_GET_CMD_BUF(HCIC_PARAM_SIZE_ENH_SETUP_ESCO)) == NULL)
        return (FALSE);
                                           ...
                                           UINT16 packet_types, UINT8 retrans_effort)
{
    ...
    if ((p = HCI_GET_CMD_BUF(HCIC_PARAM_SIZE_ENH_ACCEPT_ESCO)) == NULL)
        return (FALSE);
            ...
            UINT32 synchronization_train_to, UINT8 service_data)
{
    ...
    if ((p = HCI_GET_CMD_BUF(HCIC_PARAM_SIZE_WRITE_SYNC_TRAIN_PARAM)) == NULL)
        return (FALSE);
            ...
            UINT8 which_clock, UINT8 lpo_allowed, UINT8 num_clock_captures_to_filter)
{
    ...
    if ((p = HCI_GET_CMD_BUF(HCIC_PARAM_SIZE_SET_TRIGGERED_CLOCK_CAPTURE)) == NULL)
        return (FALSE);
