...
#define BTA_AV_RC_SUPF_TG       (AVRC_SUPF_TG_CAT1 | AVRC_SUPF_TG_MULTI_PLAYER | AVRC_SUPF_TG_COVER_ART)
#elif (MTK_AVRCP_TG_15 == TRUE)
#define BTA_AV_RC_SUPF_TG       (AVRC_SUPF_TG_CAT1 | AVRC_SUPF_TG_MULTI_PLAYER) /* TODO: | AVRC_SUPF_TG_APP_SETTINGS) */
#else
