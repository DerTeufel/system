...
/*******************************************************************************
**
** Function         bta_dm_mtk_is_device_blacklisted
**
** Description      This function is to check if the remote address is blacklisted
**                  (by prefix address, exact name or partial name)
**
** Parameters       remote_bd_addr  - The peer device
**                  *blacklist - Which blacklist to use
**
** Returns          BOOLEAN.
**
*******************************************************************************/
...
// Toyota touch & go issue
/*******************************************************************************
**
** Function         bta_dm_mtk_is_device_blacklisted2
**
** Description      This function is to check if the remote address and remote device name is blacklisted
**                  (by prefix address and exact name)
**
** Parameters       remote_bd_addr  - The peer device
**                  *blacklist - Which blacklist to use
**
...
*******************************************************************************/
#if MTK_STACK_CONFIG_BL == TRUE
extern BOOLEAN bta_dm_mtk_is_device_blacklisted2(BD_ADDR remote_bd_addr, const stack_config_blacklist_t *blacklist);
#endif /* MTK_STACK_CONFIG == TRUE */
