...
static int remote_read(apacket *p, atransport *t)
{
...
#if !ADB_HOST
        ADBLOG("remote local: read terminated (message)\n");
#endif
    ...
    if(check_header(p)) {
#if !ADB_HOST
        ADBLOG("bad header: terminated (data)\n");
#endif
...
#if !ADB_HOST
        ADBLOG("remote local: terminated (data)\n");
#endif
    ...
    if(check_data(p)) {
#if !ADB_HOST
        ADBLOG("bad data: terminated (data)\n");
#endif
...
#if !ADB_HOST
        ADBLOG("remote local: write terminated\n");
#endif
