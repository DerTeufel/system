...
static int create_service_thread(void (*func)(int, void *), void *cookie)
{
    ...
    if (adb_socketpair(s)) {
#if !ADB_HOST
        ADBLOG("cannot create service socket pair\n");
#endif
...
#if !ADB_HOST
    ADBLOG("shell exited fd=%d of pid=%d err=%d\n", fd, pid, errno);
#endif
...
#if !ADB_HOST
    ADBLOG("create_subproc ret_fd=%d pid=%d\n", ret_fd, pid);
#endif
